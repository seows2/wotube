...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"../node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar commentList = document.getElementById(\"jsCommentList\");\nvar delBtns = document.querySelectorAll(\".fas.fa-trash-alt\");\nvar commentCount = document.querySelector(\".video__comment-number\");\n\nvar commentCountDown = function commentCountDown() {\n  var Num = parseInt(commentCount.innerText.replace(/[^0-9]/g, '')) - 1;\n  commentCount.innerText = \"\\uB313\\uAE00 \".concat(Num, \"\\uAC1C\");\n};\n\nvar delComment = function delComment(target) {\n  var delBtn = target.parentElement;\n  var div = delBtn.parentElement;\n  var li = div.parentElement;\n  commentList.removeChild(li);\n  commentCountDown();\n};\n\nvar handleClick =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(event) {\n    var target, commentId, response;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            target = event.target;\n            commentId = target.id;\n            _context.next = 4;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default()({\n              url: \"/api/\".concat(commentId, \"/delete\"),\n              method: \"POST\",\n              data: {\n                commentId: commentId\n              }\n            });\n\n          case 4:\n            response = _context.sent;\n\n            if (response.status === 200) {\n              delComment(target);\n            }\n\n          case 6:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function handleClick(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar addEvent = function addEvent() {\n  delBtns.forEach(function (el) {\n    el.addEventListener(\"click\", handleClick);\n  });\n};\n\nfunction init() {\n  addEvent();\n}\n\nif (delBtns) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/delComments.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"../node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! /Users/seows/Documents/vsCode/wotube/src/assets/js/main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");
